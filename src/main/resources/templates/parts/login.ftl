    					...
    					<div class="form-group row">
							<div class="btn-group">
								<button type="button" class="btn btn-default dropdown-toggle"
									...
									<span id="selected" data-bind="label">+380</span><span class="caret"></span>
								</button>
								<ul class="dropdown-menu" role="menu">
									<li class="option" style="cursor: pointer;"><span class="flag-icon flag-icon-ua"></span>+380</li>
									<li class="option" style="cursor: pointer;"><span class="flag-icon flag-icon-gb"></span>+44</li>
